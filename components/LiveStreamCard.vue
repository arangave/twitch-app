...
.live-title { font-size: 1.25rem; font-weight: 500; margin-bottom: 0.5rem; color: $text-light; &--blue { color: $primary-color; font-weight: 600; } }
.grid-streams {
...
.stream-card {
  background: $background-dark; border-radius: 0.5rem; overflow: hidden; display: flex; flex-direction: column;
  ...
  &__user { color: $text-muted; font-size: 0.8rem; display: flex; align-items: center; gap: 0.4rem;
...
.show-more { margin-top: 1.5rem; display: flex; justify-content: center; align-items: center; gap: 0.4rem; cursor: pointer; font-size: 0.95rem; font-weight: 500; color: $primary-color;
